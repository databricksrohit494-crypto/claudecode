...
- You need to run the Python Script stored at ".claude/skills/visualize/Scripts/visualize_data.py". This script will generate visualizations based on the data you have and save them in the appropriate directory.